...
SIS8300Config("$(PORT)", "/dev/sis8300-1", $(NUM_CH), $(NUM_SAMPLES), 7, 0, 0)
...
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),TYPE=Float64,FTVL=DOUBLE,NELEMENTS=$(NUM_SAMPLES)")
